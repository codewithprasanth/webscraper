...
export const config = {
  ...
  WHATSAPP_PHONE_NUMBERS: (process.env.WHATSAPP_PHONE_NUMBERS || process.env.WHATSAPP_PHONE_NUMBER || '917200632341@c.us').split(',').map(num => num.trim()),
  ...
  MIN_DISCOUNT_PERCENTAGE: parseInt(process.env.MIN_DISCOUNT_PERCENTAGE || '90'),
